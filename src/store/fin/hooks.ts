...
export const selectIsAppLoading: WacaiStateSelector<boolean> = createSelector(
  selectFin,
  fin => fin.isAppLoading
);
export const selectIsCreatingTemplate: WacaiStateSelector<boolean> =
  createSelector(selectFin, fin => fin.isCreatingTemplate);
...
export const useIsAppLoading = () => useAppSelector(selectIsAppLoading);
export const useIsCreatingTemplate = () =>
  useAppSelector(selectIsCreatingTemplate);
